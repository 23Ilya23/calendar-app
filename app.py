...
def check_status_zayvka():
    ...
    GET /check_status_zayvka?username=ivan&password=123456
    """
    try:
        ...
        if not username or not password:
            return jsonify({'is_zayvka': 'false', 'logged_in': False})
        ...
        return jsonify({'is_zayvka': is_zayvka, 'logged_in': True})
        
    except Exception as e:
        return jsonify({'is_zayvka': 'false', 'error': str(e)}), 500
...
def api_zayvka():
    ...
    GET /api/zayvka?username=ivan&password=123456
    """
    try:
        username = request.args.get('username', '').lower()
        password = request.args.get('password')
